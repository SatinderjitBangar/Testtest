...
4. User clicks on the  back play button at the left side of the search result window
...
AC04: Previous Property image is displayed including property details such as size, no of bedrooms, no of bathrooms, Amount/month and the location
 */
public class TC_CPM_003 extends BaseClass {

	@Test(priority=1,dataProvider="DataTC_CPM_003")
	public void tc_cpm_003(String expTitle,String expHead,String numBed,String numBath,String numGarage,String minRate,String maxRate) {
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		logger.info("TC_CPM_003 started");
		...
		//Click on Back play button to display next search result
		landingpage.clkbtnBckPlay();
		logger.info("Clicked on Back play button to display next search result");
		
		//AC04:Verify Previous Property image is displayed including property details
		
		if(landingpage.verifyNxtRes())
		{
			softassert.assertTrue(true);
			logger.info("Passed AC04:Previous Search Result displayed along with details");
		}
		else
		{
			softassert.assertTrue(false);
			logger.info("Failed AC04:Previous Search Result NOT displayed properly");
		}
	...
	//Excel Data Provider Method  
			@DataProvider (name="DataTC_CPM_003")
			public Object[][] testData () throws IOException
			{		
				return XLUtils.getData(Excel_Path, "TC_CPM_003");				
