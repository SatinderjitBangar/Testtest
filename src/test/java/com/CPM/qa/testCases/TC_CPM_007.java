...
/*Test Description
 * This test case is testing that a guest can login in to the Application  
 * 1. User navigates to Cedallion System webpage     
 * 2. User Clicks Login Button on the top left corner 
 * 3.. User enters email or userid     “Cedrenter1@mailinator.com”
   4. User enters password              "Password12345$" 
   5. Guest clicks on the login link
...
AC04: Personal info page should open
 * 
 */

public class TC_CPM_007 extends BaseClass {

	@Test(priority=1,dataProvider="DataTC_CPM_007")
	public void tc_cpm_007(String expTitle,String expHead,String userID,String password) {
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		logger.info("TC_CPM_007 started");
		...
		//Assertion AC04: verify login is successful and personal info page is displayed
		if (homepage.txtPersonalInfo.isDisplayed()) {
			softassert.assertTrue(true);
			logger.info("Passed AC04:Login as Guest successful!!");
		}
		else {
			softassert.assertTrue(false);
			logger.info("Failed AC04:Login as Guest NOT successful!!");
		}
	...
	//Excel Data Provider Method  
			@DataProvider (name="DataTC_CPM_007")
			public Object[][] testData () throws IOException
			{		
				return XLUtils.getData(Excel_Path, "TC_CPM_007");				
