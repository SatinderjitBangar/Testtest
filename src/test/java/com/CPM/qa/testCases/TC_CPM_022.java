...
/*
 This test case is to verify that first name field in Co-applicant page should not be left blank or accept invalid characters
...
Case 2: Enter more than 50 characters in the first name field
...
AC02:
Case 1: User should get error message "The First Name field is required”

Case 2:  User should get error message “The First Name field may not be greater than 50 characters”

Case 3. User should get error message “The First Name field format is invalid”

Case 4: User should get error message “The First Name field format is invalid”

Case 5: User should get error message “The First Name field format is invalid”
 */
public class TC_CPM_022 extends BaseClass {

	@Test(priority=1,dataProvider="DataTC_CPM_022")
	public void tc_cpm_022(String location,String numBed,String numBath,String numGarage,String minRate,String maxRate,String firstName,String lastName,String prefName,String dobYYYY, String dobMon, String dobDD, String phone,String dlNum,String state, String expYYYY, String expMon, String expDD, String ssnNum,String cofirstName,String errMsg) throws InterruptedException   {
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		logger.info("TC_CPM_022 started");
		...
		//Setting First Name on Co-Applicant info page
		coAppInfoPage.settxtFirstName(cofirstName);
		logger.info("Co-Applicant First Name Entered");
		
		//Click on next text box ie Last Name
		coAppInfoPage.clkTxtLastName();
		logger.info("Clicked on next text box ie Last Name");
				
					
		//Assertion AC02:Verify if Error Message is displayed 
							
		if (coAppInfoPage.txtErrFirstName.isDisplayed() && coAppInfoPage.txtErrFirstName.getText().equals(errMsg) ) {
				softassert.assertTrue(true);
				logger.info("Passed AC02:Invalid First Name:" + cofirstName + " Error Displayed:" + errMsg);
		} 
		else {
				softassert.assertTrue(false);
				logger.error("Failed AC02:Error NOT displayed or mismatch for Invalid First Name:" + cofirstName);
			}
	...
	//Excel Data Provider Method  
			@DataProvider (name="DataTC_CPM_022")
			public Object[][] testData () throws IOException
			{		
				return XLUtils.getData(Excel_Path, "TC_CPM_022");				
