...
/*This test case is to verify that City field cannot be left blank
1. User leaves City field blank and clicks enter
...
Assumption made:
Error displayed is "The City field is required" and not "This field cannot be left empty"

*/


public class TC_CPM_033 extends BaseClass{

	@Test(priority=1,dataProvider="DataTC_CPM_033")
	//@Test(priority=1)
	public void tc_cpm_033(String employerName,String employerAddress,String employerCity,String employerState) throws InterruptedException{
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		logger.info("TC_CPM_033 started");
		...
		//Leaving the City text field empty 
		employementHistorypage.settxtCity(employerCity);
		logger.info("Left City textfield empty");
		//Entering the valid province/State and taking city textfield out of focus
		employementHistorypage.settxtState(employerState);
		
		//Assertion AC01.User should get an error message"The City field is required"
		if (employementHistorypage.cityErrorIsDisplayed()) {
			softassert.assertTrue(true);
			logger.info("Passed AC01:error message is displayed when the City textfield is left empty - 'The City field is required'");
		}
		else {
			softassert.assertTrue(false);
			logger.info("Failed AC01: error message is not displayed when the City field is left empty");
		}
	...
	@DataProvider (name="DataTC_CPM_033")
	public Object[][] testData () throws IOException
	{		
		return XLUtils.getData(Excel_Path, "TC_CPM_033");				
