...
1. User leaves Zip code field blank and clicks enter
...
Assumption made:
Error displayed is "The Zip/Postal Code field is required" and not "This field cannot be left empty"

*/


public class TC_CPM_035 extends BaseClass{

	@Test(priority=1,dataProvider="DataTC_CPM_035")
	public void tc_cpm_034(String employerName,String employerAddress,String employerCity,String postalCode,String employerState) throws InterruptedException{
		driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
		logger.info("TC_CPM_035 started");
		...
		//Entering Valid State name
		employementHistorypage.settxtState(employerState);
		logger.info("Entered Valid State name");
		//Entering empty string in Zip code textfield
		employementHistorypage.settxtZip(postalCode);
		logger.info("Left Zip/Postal Code textfield empty");
		//Pressing tab to get State/Province textfield out of focus
		employementHistorypage.moveOutOfFocus(employementHistorypage.txtZip);
		
		//Assertion AC01.User should get an error message"The Zip/Postal Code field is required"
		if (employementHistorypage.zipErrorIsDisplayed()) {
			softassert.assertTrue(true);
			logger.info("Passed AC01:error message is displayed when the ZIP/Postal Code field is left empty - 'The Zip/Postal Code field is required'");
		}
		else {
			softassert.assertTrue(false);
			logger.error("Failed AC01: error message is not displayed when the ZIP/Postal Code field is left empty");
		}
	...
	@DataProvider (name="DataTC_CPM_035")
	public Object[][] testData () throws IOException
	{		
		return XLUtils.getData(Excel_Path,"TC_CPM_035");				
