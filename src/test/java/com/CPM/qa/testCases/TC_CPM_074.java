...
/*
 * This test case is to verify that Pets field can be left blank
 * 1. User leaves pet description box blank and clicks Submit.
...
public class TC_CPM_074 extends BaseClass {
	...
	//Excel Data Provider Method  
			@DataProvider (name="DataTC_CPM_074")
			public Object[][] testData () throws IOException
			{		
				return XLUtils.getData(Excel_Path, "TC_CPM_074");				
