...
/*
 This test case is to verify that Vehicles Plate number field can take alphanumeric
 1. User enters valid vehicle Plate number and clicks submit
...
public class TC_CPM_075 extends BaseClass {
	...
	//Excel Data Provider Method  
			@DataProvider (name="DataTC_CPM_075")
			public Object[][] testData () throws IOException
			{		
				return XLUtils.getData(Excel_Path, "TC_CPM_075");				
