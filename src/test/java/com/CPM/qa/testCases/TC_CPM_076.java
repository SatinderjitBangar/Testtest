...
/*
This test case is to verify that all Vehicles field can be left blank
1. User leaves the fields blank and clicks submit
...
public class TC_CPM_076 extends BaseClass {
	...
	//Excel Data Provider Method  
			@DataProvider (name="DataTC_CPM_076")
			public Object[][] testData () throws IOException
			{		
				return XLUtils.getData(Excel_Path, "TC_CPM_076");				
