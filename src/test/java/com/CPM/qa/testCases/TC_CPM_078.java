...
/*
 This test case is to verify that Water Filled Furniture field can be left blank
1. User leaves Water Filled Furniture box blank and clicks submit.
...
public class TC_CPM_078 extends BaseClass {
	...
	//Excel Data Provider Method  
			@DataProvider (name="DataTC_CPM_078")
			public Object[][] testData () throws IOException
			{		
				return XLUtils.getData(Excel_Path, "TC_CPM_078");				
